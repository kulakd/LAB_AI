...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 16:34 on niedziela, 4 czerwca 2023.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public bool[] vbool__0
		{
			...
			set {
				if ((value!=null)&&(value.Length!=10)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+10)+" was expected for variable \'vbool__0\'");
				}
		...
		private void Changed_vbool__0()
		{
			...
			this.vbool__0_marginal_F = new DistributionStructArray<Bernoulli,bool>(10);
			for(int index0 = 0; index0<10; index0++) {
